 ...
 */
final class Version20220406124704 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE commission (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, user_id INTEGER DEFAULT NULL, title VARCHAR(255) NOT NULL, state INTEGER NOT NULL, refsheet VARCHAR(255) NOT NULL, details CLOB DEFAULT NULL, created_at DATETIME NOT NULL --(DC2Type:datetime_immutable)
        )');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__posts AS SELECT id, users_id, title, content, files, created_at FROM posts');
        ...
        $this->addSql('INSERT INTO posts (id, users_id, title, content, files, created_at) SELECT id, users_id, title, content, files, created_at FROM __temp__posts');
